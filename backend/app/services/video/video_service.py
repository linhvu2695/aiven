...
from app.core.database import delete_document, find_documents_with_filters, count_documents_with_filters, update_document, MongoDB
...
class VideoService:
    ...
    async def create_video(self, request: CreateVideoRequest) -> CreateVideoResponse:
        ...
        try:
            ...
            # Insert into MongoDB
            video_id = await MongoDB().insert_document(VIDEO_COLLECTION_NAME, document)
